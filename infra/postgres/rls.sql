...
ALTER TABLE developer_identifiers FORCE ROW LEVEL SECURITY;
...
ALTER TABLE developer_merge_logs FORCE ROW LEVEL SECURITY;
...
ALTER TABLE activity_campaigns FORCE ROW LEVEL SECURITY;
...
ALTER TABLE plugin_runs FORCE ROW LEVEL SECURITY;
...
ALTER TABLE plugin_events_raw FORCE ROW LEVEL SECURITY;
...
ALTER TABLE shortlinks FORCE ROW LEVEL SECURITY;
...
ALTER TABLE developer_stats FORCE ROW LEVEL SECURITY;
...
ALTER TABLE funnel_stages FORCE ROW LEVEL SECURITY;
...
ALTER TABLE activity_funnel_map FORCE ROW LEVEL SECURITY;
